INSERT INTO departments (dep_code, name) VALUES -- might be useful if we want the user to add wants after the needs are satisfied
...
SELECT c.course_id, c.title, t.req_name
