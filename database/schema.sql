...
CREATE TABLE courses (
    course_id INT NOT NULL PRIMARY KEY, -- maps to courseGroupId for scraper 
    course_short_name TEXT NOT NULL,              -- e.g. 'CSCI 127000 
    course_long_name TEXT NOT NULL,             -- e.g. 'Introduction to Computer Science'
    course_code TEXT NOT NULL,                 -- e.g. '127000'
...
CREATE INDEX idx_courses_subject_number ON courses(dep_code, course_code); -- index for dep_code and course_code lookups
...
/* Requirement types (as of 02/09/26):
   Accounting Minor Core, Accounting Minor Elective, Adolescene Education:  Major Core, Accounting Major Elective,
...
SELECT c.course_id, c.course_short_name as title, c.course_description, t.req_name
